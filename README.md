...
* 插入排序是一种优化算法，叫做拆半插入。
![insertionSort](sort-algorithm（排序算法）\img\insertionSort.gif)
...
![bubbleSort](sort-algorithm（排序算法）\img\bubbleSort.gif)
...
![quickSort](sort-algorithm（排序算法）\img\quickSort.gif)
...
![selectionSort](sort-algorithm（排序算法）\img\selectionSort.gif)
...
![heapSort](sort-algorithm（排序算法）\img\heapSort.gif)
...
![mergeSort](sort-algorithm（排序算法）\img\mergeSort.gif)
...
![radixSort](sort-algorithm（排序算法）\img\radixSort.gif)
